...
class QLearningLayer(tf.keras.layers.Layer):
    def __init__(self, action_space_size, state_size, learning_rate=0.01, gamma=0.95, epsilon=0.1):
        ...
        self.q_network = tf.keras.layers.Dense(action_space_size, activation=None)
...
def load_model(model_path):
    ...
    """
    try:
        model = tf.keras.models.load_model(model_path, custom_objects={'QLearningLayer': QLearningLayer, 'RBMLayer': RBMLayer})
